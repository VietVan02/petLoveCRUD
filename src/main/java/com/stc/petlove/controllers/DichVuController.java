...
public class DichVuController {
    ...
    public ResponseEntity<DichVu> create(@Valid @RequestBody DichVuDto dto) {
        return new ResponseEntity<>(dichVuService.createDichVu(dto), HttpStatus.OK);
    }

    @PutMapping("/{id}")
    public ResponseEntity<DichVu> update(@PathVariable String id, @Valid @RequestBody DichVuDto dto) {
        return new ResponseEntity<>(dichVuService.updateDichVu(id, dto), HttpStatus.OK);
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<DichVu> delete(@PathVariable String id) {
        return new ResponseEntity<>(dichVuService.deleteDichVu(id), HttpStatus.OK);
    }
}
